...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(91), __webpack_require__(9)))
...
var m=__webpack_require__(16),n=__webpack_require__(17),p=__webpack_require__(6),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(36),B=__webpack_require__(16),C=__webpack_require__(6),ba=__webpack_require__(37),da=__webpack_require__(38),ea=__webpack_require__(39),fa=__webpack_require__(40),ia=__webpack_require__(43),D=__webpack_require__(17);
...
var _Regin = __webpack_require__(93);

var _Regin2 = _interopRequireDefault(_Regin);

var _ToEmail = __webpack_require__(94);

var _ToEmail2 = _interopRequireDefault(_ToEmail);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: "/regin", component: _Regin2.default }),
                _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: "/toEmail", component: _ToEmail2.default })
            )
        )
    );
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9), __webpack_require__(56)(module)))
...
var _jsMd = __webpack_require__(31);
...
var Login = function (_React$Component) {
    ...
    _createClass(Login, [{
        ...
        value: function getUserName() {
            var unameVal = window.event.target.value;
            this.setState({
                account: unameVal
            });
        }
        ...
        key: "getPwd",
        value: function getPwd() {
            var pwdVal = window.event.target.value;
            this.setState({
                pwd: pwdVal
            });
        }
        ...
        key: "LoginFetch",
        value: function LoginFetch() {
            var urlApi = "/api/login";
            var sendData = Object.assign({}, this.state);
            if (sendData.username == "" || sendData.pwd == "") {
                alert("用户名或密码,不能为空!");
                return false;
            }
            sendData['pwd'] = (0, _jsMd2.default)(sendData['pwd']);
            fetch(urlApi, {
                method: "post",
                headers: {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", { type: "text", "class": "formControl", onChange: this.getUserName.bind(this) })
                ),
                _react2.default.createElement(
                    "div",
                    { "class": "formGroup" },
                    ...
                    _react2.default.createElement("input", { type: "password", "class": "formControl", onChange: this.getPwd.bind(this) })
                ),
                _react2.default.createElement(
                    "div",
                    { "class": "btnGroup" },
                    ...
                    _react2.default.createElement(
                        "button",
                        { type: "button", "class": "btn btn-primary", onClick: this.LoginFetch.bind(this) },
                        "\u767B\u5F55"
                    ),
                    _react2.default.createElement(
                        "button",
...
var Regin = function (_React$Component) {
    _inherits(Regin, _React$Component);

    function Regin(props) {
        _classCallCheck(this, Regin);

        var _this = _possibleConstructorReturn(this, (Regin.__proto__ || Object.getPrototypeOf(Regin)).call(this, props));
    ...
    _createClass(Regin, [{
        ...
        key: "getPwd",
        value: function getPwd(typeStr) {
            var pwdVal = window.event.target.value;
            this.setState(_defineProperty({}, typeStr, pwdVal));
        }
    }, {
        key: "getEmail",
        value: function getEmail() {
            var emailVal = window.event.target.value;
            this.setState({
                email: emailVal
            });
        }
        ...
        key: "reginFetch",
        value: function reginFetch() {
            var _this2 = this;

            var urlApi = "/api/regin";
            ...
            sendData['pwd'] = (0, _jsMd2.default)(this.state['pwd1']);
            ...
            fetch(urlApi, {
                ...
                result.json().then(function (res) {
                    if (res.status) {
                        ...
                        _this2.props.history.push("/toEmail");
                    }
                });
            });
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", { type: "password", "class": "formControl", onChange: this.getPwd.bind(this, "pwd1") })
                ),
                _react2.default.createElement(
                    "div",
                    { "class": "formGroup" },
                    ...
                    _react2.default.createElement("input", { type: "password", "class": "formControl", onChange: this.getPwd.bind(this, "pwd2") })
                ),
                _react2.default.createElement(
                    "div",
                    { "class": "formGroup" },
                    ...
                    _react2.default.createElement("input", { type: "password", "class": "formControl", onChange: this.getEmail.bind(this) })
                ),
                _react2.default.createElement(
                    "div",
                    { "class": "btnGroup" },
                    ...
                    _react2.default.createElement(
                        "button",
                        { type: "button", "class": "btn btn-primary", onClick: this.reginFetch.bind(this) },
                        "\u6CE8\u518C"
                    ),
                    _react2.default.createElement(
                        "button",
...
var ToEmail = function (_React$Component) {
    _inherits(ToEmail, _React$Component);

    function ToEmail(props) {
        _classCallCheck(this, ToEmail);

        var _this = _possibleConstructorReturn(this, (ToEmail.__proto__ || Object.getPrototypeOf(ToEmail)).call(this, props));

        _this.state = {
            account: "",
            email: ""
        };
        _this.sendDataJson = null;
        return _this;
    }

    _createClass(ToEmail, [{
        key: "componentDidMount",
        value: function componentDidMount() {
        ...
        key: "getUserName",
        value: function getUserName() {
            var accountVal = window.event.target.value;
            this.setState({
                account: accountVal
            });
        }
        ...
        key: "emailFetch",
        value: function emailFetch() {
            var urlApi = "/api/toEmail";
            var sendData = null;
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "button",
                        { type: "button", "class": "btn btn-primary", onClick: this.emailFetch.bind(this) },
                        "\u5F00\u59CB\u6FC0\u6D3B"
                    )
                )
            );
...
exports.default = ToEmail;

/***/ })
],[32]);
//# sourceMappingURL=main-bb2812008a85fe513ec0.js.map